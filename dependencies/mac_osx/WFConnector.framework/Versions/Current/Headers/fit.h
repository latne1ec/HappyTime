...
#define FIT_PROFILE_VERSION_MAJOR            2
...
#define FIT_FIELD_NUM_CHECKSUM         ((FIT_UINT8)252)
#define FIT_FIELD_NUM_PAD              ((FIT_UINT8)251)
...
#define FIT_CHECKSUM_FIELD_NUM         FIT_FIELD_NUM_CHECKSUM // For reverse compatibility only.  Use FIT_FIELD_NUM_CHECKSUM instead.
